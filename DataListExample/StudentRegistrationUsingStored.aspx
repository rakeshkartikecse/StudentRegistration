...
<body>
    ...
    <p>
        ...
        <div>
            ...
            <br />
           <asp:GridView ID="GridView1" runat="server"  OnRowEditing ="GridView1_RowEditing"  DataKeyNames ="ID" BorderColor="Yellow" BackColor="#FFCCFF"  OnRowUpdating="GridView1_RowUpdating"         
            OnRowDeleting ="GridView1_RowDeleting" OnRowCommand="GridView1_RowCommand"  AutoGenerateColumns="False" OnSelectedIndexChanged="GridView1_SelectedIndexChanged" PageSize="50" OnPageIndexChanging="GridView1_PageIndexChanging" >
               <Columns>
