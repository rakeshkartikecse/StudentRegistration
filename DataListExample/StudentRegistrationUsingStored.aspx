...
<body>
    ...
    <p>
        ...
        <div>
            ...
            <br />
           <asp:GridView ID="GridView1" runat="server" DataKeyNames ="ID" OnRowEditing ="GridView1_RowEditing"  BorderColor="Yellow" BackColor="#FFCCFF" OnRowDataBound="GridView1_RowDataBound" OnRowCancelingEdit="GridView1_RowCancelingEdit" OnRowUpdating="GridView1_RowUpdating1"          
            OnRowDeleting ="GridView1_RowDeleting" OnRowCommand="GridView1_RowCommand" AutoGenerateDeleteButton="true" OnSelectedIndexChanged="GridView1_SelectedIndexChanged" PageSize="50" AllowPaging="false" OnPageIndexChanging="GridView1_PageIndexChanging" >
               <Columns>
